        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    <li class="nav-item">
                        <a href="{{ url('customer-dashboard') }}" class="nav-link active text-primary fw-bold">Home</a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ url('#') }}" class="nav-link active text-primary fw-bold" href="#">About</a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ url('#') }}" class="nav-link active text-primary fw-bold" href="#">Rentals</a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ url('#') }}" class="nav-link active text-primary fw-bold" href="#">Contact</a>
                    </li>
                </ul>
